// First large green hill you see
class BigHill { 
...
/*
Second, smaller hill (green thing in background)
For game engine to update, needs update() and draw() method
*/
class Hill {
    constructor(game, x, y) {
        Object.assign(this, { game, x, y });
